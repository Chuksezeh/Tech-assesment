        ...
        <header className="navbar-container">
            <div className="navbar-left">
                ...
                <form className="newsletter-form" onSubmit={(e) => e.preventDefault()}>
                  ...
                  <div className="mobile-dropdown"><img  className="image-profile-li" style={{width:"30px", height:"30px", borderRadius:"50px"}} /><ArrowIcon size={20}/> </div>
                 <ul className="navbar-menu">
                  <li className="" style={{textDecoration:"underline"}}>Docs</li>
                  <li><BellIcon size={20} /> </li>
                  <li  className="image-profile-li"> <img  className="image-profile-li" style={{width:"30px", height:"30px", borderRadius:"50px"}} /> </li>
                  <li className="" style={{width:"150px"}}>  Chuks <ArrowIcon/>  </li>
            </ul>
            </div>
